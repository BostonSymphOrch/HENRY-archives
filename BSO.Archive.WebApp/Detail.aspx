                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <ul class="programList">
                                    ...
                                    <li>
                                        <asp:Repeater runat="server" ID="workMediaLinks">
                                            <ItemTemplate>
                                                <asp:HyperLink runat="server" ID="MediaLink"><img src="/Images/icon.png" width="16" height="16" alt="Play Media" /></asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                        
                                        <asp:HyperLink runat="server" ID="ComposerFullName" CssClass="detailPageComposerLink" NavigateUrl="~/Search.aspx?searchType=Performance&Composer={0}" /></li>

                                    <li>
                                        <asp:HyperLink runat="server" ID="WorkTitle" CssClass="detailPageWorkLink" NavigateUrl="~/Search.aspx?searchType=Performance&Work={0}&Composer={1}" /></li>
                                ...
                                <p class="notes"><span class="detailTitle">
                                    <asp:Label runat="server" Text="Notes:" ID="WorkNotesLabel" /></span>
                                    <asp:Label ID="WorkNotes" runat="server" /><br />
                                    <br />
                                    <span class="detailTitle">
                                        <asp:Label runat="server" ID="WorkPremiereLabel" Text="Work Premiere:" /></span><asp:Label ID="WorkPremiere" runat="server" /></p>
                            </td>
                        </tr>
